...
function ProfilesOrder() {
  ...
  return (
    <>
      <Container className={`mt-3 ps-0`} fluid style={{ overflow: 'scroll' }}>
              ...
              orders.map((order: Iproduct) => {
                return (
                  <tr>
                    ...
                    <td>{order.phone}</td>
                    <td>
                      <Button size="sm" onClick={() => handleClick(order)}>
                        Chi tiết
                      </Button>
                    </td>
                    <td >
      ...
      <Modal show={show} onHide={() => setShow(false)} size="xl" >
        ...
        <Modal.Body style={{ overflow: 'scroll' }}>
          <Table bordered className={`overflow-scroll ${style.tableOrder}`}>
            <thead>
              <tr>
                <th>Tên</th>
                <th>Số lượng</th>
