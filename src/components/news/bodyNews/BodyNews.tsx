        ...
        <div className={styles.category}>
            ...
            <div className={`${styles["category_content"]} ${styles["container"]}`}>
                <div className={styles.category_side_bar}>
                    ...
                    <div className={styles.category_banner_promotion}>
                        <a href="https://tocotocotea.com/" className={styles.alink}>
                            <img className={`${styles.banner_item} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2021/10/ft2-2-img.webp" alt="" />
                        </a>
                        <a href="" className={styles.alink}>
                            <img className={`${styles.banner_item} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2021/10/ft2-1-img.webp" alt="" />
                        </a>
                    </div>
                ...
                <div className={styles.category_main}>
                    < div className={styles.category_main_title}>Tin tức</div>
                    <div className={styles.category_main_content}>
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/hoc-me-say-tra-sua-ngat-ngay-voi-chuong-trinh-tocotoco-x-marathon-education/">
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/kham-pha-dia-diem-check-in-cua-hang-moi-pham-huu-lau-cua-tra-sua-tocotoco/">
                            <img className={`${styles.feature_img} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2022/03/grand-openning-Pham-Huu-Lau.jpg" alt="" />
                            <div className={styles.post_card_content}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/mung-khai-truong-cua-hang-nguyen-van-khoi/">
                            <img className={`${styles.feature_img} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2022/03/grand-openning-Nguyen-Van-Khoi.jpg" alt="" />
                            <div className={styles.post_card_content}>
                                < div className={
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tung-bung-khai-truong-cua-hang-ha-huy-giap/">
                            <img className={`${styles.feature_img} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2022/03/grand-openning-Ha-Huy-Giap.jpg" alt="" />
                            <div className={styles.post_card_content}>
                                < div className={
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/su_kien/tocotoco_chuc_mung_chu_nhan_trung_giai_thuong_iphone_13_promax_va_hang_ngan_phan_qua_khung/">
                            <img className={`${styles.feature_img} ${styles.image}`} src="https://tocotocotea.com/wp-content/uploads/2022/01/Hinh-1.png" alt="" />
                            <div className={styles.post_card_content}>
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/su-kien/uong-da-them-san-deal-da-doi/">
                        ...
                        <a className={`${styles.post_card} ${styles.alink}`} href="https://tocotocotea.com/blogs/tin-tuc-khuyen-mai/danh-sach-cua-hang-tocotoco-ap-dung-ctkm/">
                    ...
                    <nav className={`${styles.navigation} ${styles.pagination} ${styles.navigation}`} role="navigation" ></nav>
                    < h2 className={`${styles.screen_reader_text} ${styles.h2_title}`}>Posts navigation</h2>
                    <div className={styles.nav_links}>
                        <span aria-current="page" className={`${styles.page_numbers} ${styles.current}`}> 1</span>
                        <a className={`${styles.page_numbers} ${styles.alink}`} href="https://tocotocotea.com/category/blogs/page/2/">2</a>
                        <span className={`${styles.page_numbers} ${styles["dots"]}`}>…</span>
                        < a className={`${styles.page_numbers} ${styles.alink}`} href="https://tocotocotea.com/category/blogs/page/21/">21</a>
                        < a className={`${styles["next"]} ${styles["page_numbers"]}  ${styles.alink}`} href="https://tocotocotea.com/category/blogs/page/2/">»</a>
                    </div>
                </div >
            </div >
        </div >
