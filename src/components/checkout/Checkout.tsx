...
import { DeliveryTimePopup, PromotionCodePopup, SuccessOrderPopup, CheckCartPopup, SearchBoxPopup, BackToLoginPupop } from './popup/Popups'
                ...
                <div className={`${style.deliveryInfo} ${style.orderInfo}`}>
                  ...
                  <div className={style.deliveryInfoContent}>
                    ...
                    <div className={style.wrapCheckoutBtn}>
                      ...
                      <button className={style.btnBackToMenu}><Link to="/product">TIẾP TỤC MUA HÀNG</Link></button>
                    </div>
                  </div>
                </div>
              </Col>
